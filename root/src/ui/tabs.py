    ...
    def gather_data(self):
        ...
        def calculate_target_hc(row):
            try:
                ...
                new_target_hc = (planned_cases / cph) / hours_remaining
        ...
        try:
            ...
            self.data['combined_data']['process_level'] = (
                ...
                .with_columns([
                    pl.struct(['planned_cases', 'avg_cph', 'historical_cph', 'target_hc'])
            ...
            try:
                ...
                for path in unique_paths:
                                            ...
                                            for group_idx, (group_rows, color) in enumerate(self._group_pick_areas(palatable_data)):
                                                ...
                                                if row in group_rows:
                                                    ...
                                                    for group_row in group_rows:
                                                        try:
                                                            picks = float(group_row['Planned']) or float(group_row['Picks']) or 0
                    ...
                    try:
                        ...
                        #if planned_picks > 0:
                        create_metric_label("Planned Picks", str(planned_picks))
                        #else:
