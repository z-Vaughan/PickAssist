...
class TimeManager:
    ...
    def calculate_shift_times(cls, start_hour, end_hour):
        ...
        pad_time = cls._shift_time.pad_time if cls._shift_time else td(seconds=0)
        ...
        if pad_time > td(seconds=0):
            hours_remaining = end_time - now - pad_time
            elapsed_seconds = elapsed_time.total_seconds()
            total_seconds = hours_remaining.total_seconds() + elapsed_seconds
